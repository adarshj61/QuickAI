        ...
        <div className="md:max-w-96">
                   <img className='h-9' src={assets.logo} alt="dummyLogoDark" />
                    <p className="mt-6 text-sm">
                        QuickAI is your go-to platform for leveraging the power of AI in content creation.<br/> Our suite of tools is designed to help you create, edit, and enhance your content with ease and efficiency.</p>
                </div>
